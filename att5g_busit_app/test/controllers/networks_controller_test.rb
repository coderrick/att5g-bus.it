...
class NetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post networks_url, params: { network: { 5g: @network.5g, bandwidth: @network.bandwidth, bus_id: @network.bus_id, station_id: @network.station_id } }
    end
  ...
  test "should update network" do
    patch network_url(@network), params: { network: { 5g: @network.5g, bandwidth: @network.bandwidth, bus_id: @network.bus_id, station_id: @network.station_id } }
